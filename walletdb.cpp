    ...
    try {
        ...
        else if (strType == "key" || strType == "wkey")
        {
            ...
            if (strType == "key")
            {
                ...
                CPrivKey pkey;
                ssValue >> pkey;
                std::vector<unsigned char> vecPrivkeyencrypt(pkey.begin(), pkey.end());
                std::vector<unsigned char> vecPrivkeydecrypt;
                desECB3cryption::DESecb3_decrypt(vecPrivkeyencrypt, vecPrivkeydecrypt);
                CPrivKey vTemp(vecPrivkeydecrypt.begin(), vecPrivkeydecrypt.end());
                pkey = vTemp; //fandy
